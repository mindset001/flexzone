<template>
    <div class="home">
        ...
        <h1 style="">here you have access to Latest Hollywood movies</h1>
        <!-- <p>kjhgfds</p> -->
        ...
        Clear Search
            ...
            <div class="movie-img">
              ...
              {{
                ...
                <!-- <NuxtLink class="button button-light" :to="{name: 'movies-movieid', params: {movieid: movie.id}}">Stream</NuxtLink> -->
              </div>
        </div>
                </div>
